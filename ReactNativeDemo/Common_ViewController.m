...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Demo_ViewController *VC = [[Demo_ViewController alloc] init];
    VC.moduleName = [NSString stringWithFormat:@"RNDemo%@",_jsNumberArray[indexPath.row]];
    VC.title = _subtitleArray[indexPath.row];
